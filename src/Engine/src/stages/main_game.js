...
``
      ...
      ps.exitMainLoop = ps.exitMainLoop || ps.keyboard.isPressed('ESC');

      if (ps.exitMainLoop) {
        console.log('exit')
        leaveStage.bind(self)();
      } else {
        window.requestAnimationFrame(mainLoop.bind(self));
      }
    }
    ...
    let setExitMainLoop = function(bool) {
        console.log('setExitMainLoop', ps.exitMainLoop, bool);
        ps.exitMainLoop = bool;
        console.log('setExitMainLoop', ps.exitMainLoop, bool);
    }
    ...
    self.setExitMainLoop = setExitMainLoop;
